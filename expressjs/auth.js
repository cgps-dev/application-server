...
const accessTokensMiddleware = require("./access-tokens");
...
module.exports = function (userOptions) {
  ...
  app.use(
    sessionMiddleware({
      ...
      mongodbUrl: options.mongoSessionStoreDbUrl
    })
  );
  ...
  if (options.userStore.findByAccessToken) {
    app.use(
      accessTokensMiddleware({
        getUser: options.userStore.findByAccessToken,
      })
    );
  }
